...
export const ManageBookings: React.FC = () => {
  ...
  const fetchBookings = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/api/bookings/facility/${selectedFacility}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const getTotalRevenue = () => {
    return filteredBookings
      ...
      .reduce(
        (total, booking) => total + parseFloat(booking.total_amount || 0),
        0
      );
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            View and manage court bookings for your facilities
          </p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">
              Choose a facility to view its bookings
            </p>
          </div>
        ) : filteredBookings.length === 0 ? (
          <div className="text-center py-12">
